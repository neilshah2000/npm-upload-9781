...
var txncheck = function (_a) {
    ...
    function checkResponseValidity(responseObject) {
        return responseObject.validamounts && responseObject.valid.basic && responseObject.valid.mmrproofs && responseObject.valid.scripts && responseObject.valid.signatures;
    }
};
...
var txnoutput = function (_a) {
    ...
    var command = "txnoutput " + "".concat(buildArg("id", id), " ") + "".concat(buildArg("amount", amount), " ") + "".concat(buildArg("address", address), " ") + "".concat(buildArg("tokenId", tokenId), " ") + "".concat(buildArg("storeState", storeState));

 ...
 * @param uid
 */
var sendpoll = function (_a) {
    var action = _a.action, uid = _a.uid;
    var command = "sendpoll " + "".concat(buildArg('action', action), " ") + "".concat(buildArg('uid', uid));
